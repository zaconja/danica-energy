...
class MILPDayAheadOptimizer:
    ...
    def optimize(self, initial_soc=0.0):
        ...
        # Ugovor – pretvori u listu s jednim elementom
        contracts = [{
...
class _MILPCore:
    """
    Interna klasa koja zapravo obavlja MILP optimizaciju.
    Potpuno neovisna i nevidljiva za app.py.
    """
    ...
    def optimize(self, initial_soc: float = 0.0) -> Dict[str, Any]:
        """Pokreće MILP optimizaciju i vraća rezultate."""
    ...
    def _build_model(self, initial_soc: float):
        """Kreira problem, varijable i ograničenja."""
    ...
    def _extract_results(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'grid_sales': np.array(spot_sell_vals),   # za kompatibilnost
